/**
 * Icons.jsx — централізовані SVG-іконки проекту
 * Стиль: outline, strokeWidth 1.5, currentColor (успадковує колір тексту)
 * Розмір за замовчуванням: w-5 h-5 (20 px). Перевизначається через className.
 */

function Svg({ className = 'w-5 h-5', sw = 1.5, children }) {
  return (
    <svg
...
export function BeakerIcon({ className }) {
  return (
    <Svg className={className}>
...
export function DocumentArrowDownIcon({ className }) {
  return (
    <Svg className={className}>
...
/** Документ із сіткою — чітко зрозумілий "Excel / spreadsheet" */
export function SpreadsheetIcon({ className }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* контур документа з загнутим кутом */}
      <path d="M14 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V9l-6-6z" />
      {/* загін кута */}
      <path d="M14 3v6h6" />
      {/* горизонтальні лінії таблиці */}
      <line x1="8" y1="13" x2="16" y2="13" />
      <line x1="8" y1="17" x2="16" y2="17" />
      {/* вертикальний роздільник колонок */}
...
export function BanknotesIcon({ className }) {
  return (
    <Svg className={className}>
...
/* ── Склад сировини (Дашборд) ── */

/** Пшениця — стебло з колосом */
export function WheatIcon({ className }) {
  return (
    ...
    >
      ...
      {/* колос (ліва і права дуги утворюють форму колоса) */}
      <path d="M12 11C12 11 9 9 9 6C9 4 10.5 3 12 3C13.5 3 15 4 15 6C15 9 12 11 12 11Z" />
      {/* шипики */}
      <line x1="12" y1="14" x2="9.5" y2="12.5" />
      <line x1="12" y1="14" x2="14.5" y2="12.5" />
      <line x1="12" y1="17" x2="10" y2="15.5" />
      <line x1="12" y1="17" x2="14" y2="15.5" />
...
/** Кукурудза — качан з листками */
export function CornIcon({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
    ...
    >
      {/* качан */}
      <path d="M12 3C9.5 3 8 5.5 8 8.5V15.5C8 18.5 9.5 21 12 21C14.5 21 16 18.5 16 15.5V8.5C16 5.5 14.5 3 12 3Z" />
      {/* ряди зерен */}
      ...
      {/* листки */}
      <path d="M8 7C6 5.5 3.5 6 3 9" />
      <path d="M16 7C18 5.5 20.5 6 21 9" />
    </svg>
  )
}
...
export function ArrowPathIcon({ className }) {
  return (
    <Svg className={className}>
